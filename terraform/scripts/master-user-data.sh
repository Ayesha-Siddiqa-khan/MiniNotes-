...
aws ssm get-parameter --name "/terrapilot/MiniNotes /dev/kubernetes/join-command/private" --with-decryption --region "us-east-1" --query Parameter.Value --output text
aws ssm get-parameter --name "/terrapilot/MiniNotes /dev/kubernetes/join-command/public" --with-decryption --region "us-east-1" --query Parameter.Value --output text
```
...
aws ssm get-parameter --name "/terrapilot/MiniNotes /dev/kubernetes/join-command/private" --with-decryption --region "us-east-1" --query Parameter.Value --output text
aws ssm delete-parameter --name "/terrapilot/MiniNotes /dev/kubernetes/join-command/private" --region "us-east-1"
```
